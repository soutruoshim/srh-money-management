...
''';
  ...
  static String createTransaction() {
    return '''mutation InsertTransactionOne(\$wallet_id: Int = 10, \$category_id: Int = 10, \$balance: float8 = "", \$date: timestamp = "", \$note: String = "", \$type: TypeTransaction_enum = expense) {
      insert_Transaction_one(object: {wallet_id: \$wallet_id, category_id: \$category_id, balance: \$balance, date: \$date, note: \$note, type: \$type}) {
        id
        wallet_id
        category_id
        balance
...
''';
  ...
  static String updateTransaction() {
    return '''mutation UpdateTransaction(\$id: Int = 10, \$balance: float8 = "", \$category_id: Int = 10, \$date: timestamp = "", \$note: String = "", \$type: TypeTransaction_enum = expense, \$wallet_id: Int = 10) {
      update_Transaction(where: {id: {_eq: \$id}}, _set: {balance: \$balance, category_id: \$category_id, date: \$date, note: \$note, type: \$type, wallet_id: \$wallet_id}) {
        returning {
          id
          wallet_id
          category_id
