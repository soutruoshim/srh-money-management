...
class CreateTransaction extends TransactionsEvent {
  const CreateTransaction(this.transactionModel, this.startDate, this.endDate);
  ...
  @override
  List<Object> get props => [transactionModel, startDate!, endDate!];
}

class EditTransaction extends TransactionsEvent {
  const EditTransaction(this.transactionModel, this.startDate, this.endDate);
...
class RemoveTransaction extends TransactionsEvent {
  const RemoveTransaction(this.transactionModel, this.startDate, this.endDate);
